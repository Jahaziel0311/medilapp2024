<div id="newMailModal{{$fila->id}}"   class="modal fade" tabindex="-1">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-left" >
                <form action="{{route('enviar.correo')}}" method="POST" role="form" autocomplete="off">
                    @csrf
                    ...
                    <input type="hidden" name="examen_id" id="esModal" class="form-control form-control-sm" value={{$fila->id}}>                   
